		...
		<div className="w-full h-full flex flex-col gap-[12px]">
			...
			<div className="h-full flex-1 flex flex-col gap-2 md:gap-3">
				<div className="flex gap-4 md:gap-6 items-center">
					...
					<h1
						className={`capitalize bg-accent rounded-full border border-gray-200 px-4 py-1 w-fit ${eventType == "event" ? "text-cyan-600 bg-cyan-600/10" : "text-green-600 bg-green-600/10"}`}
					>
						{eventType}
					</h1>
				</div>
