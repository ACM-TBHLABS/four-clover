...
const QuotationSection = () => {
  return (
    <div className="py-[100px] flex">
      <h1 className="w-1/2 font-helvetica font-normal text-[72px] leading-[82.79px]">
        Submit Product Quotation
      </h1>
      <div className="w-1/2 max-w-[800px] flex flex-col gap-[20px]">
        ...
        <input
          ...
          className="w-full max-w-[800px] font-helvetica font-light text-[20px] leading-[23px] placeholder-[#666666] px-[24px] py-[12px] rounded-[8px] border-[0.5px] border-solid border-[#666666]"
        />
        <button className="hover:bg-black flex items-center justify-center hover:text-white transition-all duration-300 hover:scale-105 ease-in-out w-[280px] py-[16px] px-[24px] border-solid border-black border-[0.5px] rounded-[5px] text-center font-helvetica font-normal text-[24px] leading-[27.6px]">
