                ...
                return (
                  <div key={index} className="flex flex-col items-center gap-1">
                    <div
                      ...
                      style={{
                        backgroundColor: color.code.includes("#")
                          ? color.code
                          : `#${color.code}`,
                      }}
                    ></div>
            ...
            {colors?.length && colors?.length > 5 && (
              <div className="flex flex-col items-center gap-1">
                <button
                  ...
                  onClick={() => setShowLessColors(!showLessColors)}
                >
                  {showLessColors ? "Show more" : "Show less"}
                </button>
                <span className="text-[16px] font-helvetica opacity-0">-</span>
              </div>
            )}
          </div>
        </div>
          ...
          <div className="flex flex-wrap gap-2 md:gap-5">
            ...
            {sizes?.length && sizes?.length > 5 && (
              <div className="flex flex-col items-center gap-1">
                <button
                  className="h-full text-[16px] font-helvetica text-[#666666] opacity-50 hover:opacity-100 transition-opacity duration-200"
                  onClick={() => setShowLessSizes(!showLessSizes)}
                >
