  ...
  return (
    <div className="px-[24px] md:px-[150px]">
      <div className="flex xl:hidden flex-col gap-[12px]">
        ...
        <button
          className="hover:bg-black hover:text-white transition-all duration-300 md:hover:scale-105 ease-in-out w-fit md:w-[280px] py-[16px] px-[24px] border-solid border-black border-[0.5px] rounded-[5px] text-center font-helvetica font-normal text-[20px] md:text-[24px]"
          onClick={() => {
            router.push("/contact");
          }}
        >
      ...
      <div className="py-[100px] flex flex-col md:flex-row gap-[50px] justify-between cursor-default">
        <div className="flex flex-col gap-0 md:gap-[12px] transition-transform duration-300 ease-in-out group">
          <h1 className="font-helvetica font-normal text-[32px] md:text-[72px] flex items-baseline">
            10+
            <span className="font-helvetica font-light text-[28px] md:text-[42px] ml-2">
              &nbsp;years
            </span>
          </h1>
          <h1 className="font-helvetica font-light text-[28px] md:text-[42px]">
            of Experience
          </h1>
          <hr className="my-[12px]" />
          <h1 className="font-helvetica font-normal text-[18px] text-[#666666]">
        ...
        <div className="flex flex-col gap-[12px] transition-transform duration-300 ease-in-out group">
          ...
          <hr />
          <h1 className="font-helvetica font-light text-[18px] text-[#666666]">
