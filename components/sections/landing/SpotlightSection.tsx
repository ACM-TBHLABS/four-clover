			...
			<div className="w-full flex flex-col gap-8 lg:gap-[100px]">
				<div className="flex flex-col gap-5 md:gap-8">
					...
					<h1 className="font-helvetica font-light text-[18px] md:text-[24px] lg:text-[32px] w-full lg:w-1/2">
						Our journey toward advancing dental solutions is powered
						by leading institutions and businesses that share our
						vision for innovation, quality, and excellence.
					</h1>
				</div>
					...
					<div className="flex flex-col justify-start items-start gap-[50px] md:gap-5 lg:gap-8">
						{partnerships
							...
							.map((partnership) => (
								...
								>
									<div className="flex flex-col md:flex-row gap-5 lg:gap-8 justify-between">
								...
								.map((partnership) => (
									...
									>
										<ClickableWrapper
											link={partnership.link}
										>
											<div className="flex flex-col-reverse md:flex-col gap-1 lg:gap-5">
