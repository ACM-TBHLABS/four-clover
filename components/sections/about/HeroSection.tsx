...
const HeroSection = () => {
  return (
    <div className="relative h-[250px] md:h-[400px] lg:h-[600px] w-full flex flex-col justify-end items-start pb-2 md:pb-12">
      ...
      />
      <h1 className="w-full max-w-[1400px] mx-auto text-white font-helvetica font-normal text-[32px] md:text-[56px] lg:text-[64px] z-20 px-[24px] md:px-[50px] lg:px-[150px] leading-none">
        About Company
      </h1>
    </div>
  );
