...
const OurJourney = () => {
  ...
  return (
    <div
      id="journey"
      className="w-full h-fit lg:h-[600px] flex flex-col lg:flex-row-reverse justify-start gap-[50px] items-start px-6 md:px-[50px] lg:px-[150px] pb-[50px] md:py-[50px] lg:py-[100px]"
    >
      <div className="w-full lg:w-1/2 h-full lg:flex flex-col justify-center items-start gap-1 hidden">
        <img
          src={selectedItem ? urlFor(selectedItem.journey_image).url() : ""}
